...
from model.audio import Audioset, find_audio_files
from model import distrib
from model.utils import LogProgress
...
def add_flags(parser):
    ...
    parser.add_argument('--dry', type=float, default=0,
                        help='dry/wet knob coefficient.')
    parser.add_argument('--sample_rate', default=16_000, type=int, help='sample rate')
    parser.add_argument('--num_workers', type=int, default=10)
    parser.add_argument('--streaming', action="store_true",
                        help="true streaming evaluation for TUNET")


parser = argparse.ArgumentParser(
        'model.enhance',
        description="Speech enhancement using TUNET - Generate enhanced files")
add_flags(parser)
